...
To optimize the MobileCardManagement application for production, run:
...
Then navigate to [http://localhost:2509](http://localhost:2509) in your browser.
