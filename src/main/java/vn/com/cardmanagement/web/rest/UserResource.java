...
import vn.com.cardmanagement.web.rest.errors.EmailAlreadyUsedException;
import vn.com.cardmanagement.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    @Timed
    public ResponseEntity<List<User>> getAllUsersHavePendingCards() {
        final List<User> users = cardService.getAllManagedPendingUsers();
//        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/users");
